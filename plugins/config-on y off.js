...
let titulo = [ 
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.welcome ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`, 
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.detect ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,  
lenguajeGB.smsParaAdYOw() + ' ' + `${m.isGroup ? chat.autolevelup ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaOw() + ' ' + `${bot.restrict ? '🇦🇱' : '☠️'}`,    
lenguajeGB.smsParaOw() + ' ' + `${bot.antiCall ? '🇦🇱' : '☠️'}`,
lenguajeGB.smsParaOw() + ' ' + `${bot.antiSpam ? '🇦🇱' : '☠️'}`,	
lenguajeGB.smsParaOw() + ' ' + `${global.opts['self'] ? '☠️' : '🇦🇱'}`,    
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.modoadmin ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,  
lenguajeGB.smsParaOw() + ' ' + `${global.opts['autoread'] ? '🇦🇱' : '☠️'}`, 
lenguajeGB.smsParaOw() + ' ' + `${bot.temporal ? '🇦🇱' : '☠️'}`,      
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.stickers ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.autosticker ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaAdYOw() + ' ' + `${m.isGroup ? chat.reaction ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaAdYOw() + ' ' + `${m.isGroup ? chat.audios ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,  
lenguajeGB.smsParaAdYOw() + ' ' + `${m.isGroup ? chat.modohorny ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antitoxic ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaAdYOw() + ' ' + `${m.isGroup ? chat.antiver ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,  
lenguajeGB.smsParaAdYOw() + ' ' + `${m.isGroup ? chat.delete ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,  
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antifake ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,  
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiLink ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiLink2 ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiTiktok ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiYoutube ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiTelegram ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiFacebook ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,   
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiInstagram ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaAdmins() + ' ' + `${m.isGroup ? chat.antiTwitter ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}`,    
lenguajeGB.smsParaOw() + ' ' + `${global.opts['pconly'] ? '🇦🇱' : '☠️'}`,  
lenguajeGB.smsParaOw() + ' ' + `${global.opts['gconly'] ? '🇦🇱' : '☠️'}`]
...
✦ ${lenguajeGB.smsParaAdmins()} ${m.isGroup ? chat.game ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}
✦ ${usedPrefix + command} juegos
✦ 👾 Activar / desactivar los Juegos

┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈

✦ ${lenguajeGB.smsParaAdmins()} ${m.isGroup ? chat.ruleta ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}
...
✦ ${lenguajeGB.smsParaOw()} ${bot.antiPrivate ? '🇦🇱' : '☠️'}
...
✦ ${lenguajeGB.smsParaAdmins()} ${m.isGroup ? chat.modoia ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}
✦ ${usedPrefix + command} chatgpt
✦ Se activa el modo "Inteligencia Artificial" con ChatGPT en todos los chats privados.

┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈

✦ ${lenguajeGB.smsParaAdmins()} ${m.isGroup ? chat.simi ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}
...
✦ ${lenguajeGB.smsParaAdmins()} ${m.isGroup ? chat.antiTraba ? '🇦🇱' : '☠️' : lenguajeGB.smsNoGg()}
